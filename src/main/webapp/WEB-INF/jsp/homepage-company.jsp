...
<html lang="en">
  ...
  <body>
    <div style="height: 30px;width: 130px; background-color:#0a76b1;text-align: center">
      <a href="/add-user">
        <font color="white">Thêm người dùng</font>
      </a>
    </div>
            ...
            <tr>
              ...
              <td style="width: 15%; min-width:270px; text-align: center">
                <a href="/payment-company/${user.id}">
                  <img height="15" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTzYNsCQCjquUoHwtpWZ-N4r4CI-RLWAZ0ozQ&usqp=CAU"/>
                </a>
              </td>
